...
for i in np.arange(start, end, step):
    ...
    subprocess.run(
        "g++ Codes/SolvationShellLi.cpp -o Codes/SolvationShellLi", shell=True
    )
    subprocess.run("./Codes/SolvationShellLi", capture_output=True, text=True)
...
subprocess.run("rm Codes/SolvationShellLi", shell=True)

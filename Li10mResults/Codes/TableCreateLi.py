...
header1_rc3 = np.array([[""], [""], ["Li (0)"], [""], [""], ["Li (1)"], [""]])
header2_rc3 = np.array(
    [
        [""],
        ["TFSI (0)"],
        ["TFSI (1)"],
...
header1_rc4 = np.array([[""], [""], [""], ["Li (0)"], [""], [""], ["Li (1)"], [""]])
header2_rc4 = np.array(
...
header1_rc5 = np.array([[""], [""], [""], ["Li (0)"], [""], [""], ["Li (1)"], [""]])
header2_rc5 = np.array(
    [[""], [""], ["F (0)"], ["F (1)"], ["F (2)"], ["F (0)"], ["F (1)"], ["F (2)"]]
)
